...
## Input file
To examine parent-offspring relations, the script uses a dataset containing the 70K dataset from Montanari et al. (2019) combined with the newly genotyped individuals as described in Claessen et al. (2026). The input file is provided in the associated Zenodo repo.

## Output file
The script has as output a matrix containing the pairwise mendelian-errors between all individual pairs. The output file is provided in the associated Zenodo repo.
